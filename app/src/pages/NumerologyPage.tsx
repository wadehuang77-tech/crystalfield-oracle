...
import { Gem, Star, Sparkles, ChevronRight, ArrowLeft, Crown } from 'lucide-react';
...
export default function NumerologyPage() {
  ...
  const { tier, isPremium, upgradeTo, resetToFree } = usePremium();
  ...
  const handleSubmit = async (date: string, useOracle: boolean) => {
    ...
    setReport(result);
    setOracleCard(useOracle ? drawOracleCard() : null);
    setLoading(false);
  };
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "'Playfair Display', 'Inter', sans-serif" }}>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="text-sm font-semibold" style={{ color: '#c4b5fd' }}>Life Crystal</span>
      ...
      {!report ? (
        <section className="px-4 pt-4 pb-16 max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12 space-y-4">
            <div className="relative inline-flex items-center justify-center mb-2">
              ...
              <div
                ...
                style={{
                  width: 72, height: 72,
                  background: 'radial-gradient(circle at 35% 30%, rgba(167,139,250,0.3), rgba(96,165,250,0.08))',
                  border: '1px solid rgba(167,139,250,0.3)',
                  boxShadow: '0 0 40px rgba(109,40,217,0.25), inset 0 1px 0 rgba(255,255,255,0.1)',
                }}
              >
                <Gem className="w-8 h-8" style={{ color: '#c4b5fd' }} />
              </div>
            </div>
            ...
            <h1
              ...
              style={{
                ...
                filter: 'drop-shadow(0 0 16px rgba(251,191,36,0.3)) drop-shadow(0 0 36px rgba(196,181,253,0.18))',
              }}
            >
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-sm" style={{ color: 'rgba(167,139,250,0.3)' }}>
