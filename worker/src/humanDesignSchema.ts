  ...
  await env.DB.prepare(
    `INSERT INTO hd_report_section_defs (id, sort_order, icon, title, focus, generation_mode, is_paid, active)
     VALUES
       ...
       ('personality', 4, '◇', 'AI 深度人格分析', '整合類型、策略、權威、人生角色與本命十字。', 'openai', 1, 1),
       ('prescription', 5, '★', 'AI 能量處方', '提供能量管理、決策練習與環境調整建議。', 'openai', 1, 1),
       ('career', 6, '◎', 'AI 職涯方向建議', '從天賦輸出、適合角色與合作條件給出建議。', 'openai', 1, 1),
       ('love', 7, '◈', 'AI 愛情關係分析', '分析親密關係中的需求、界線與溝通節奏。', 'openai', 1, 1),
       ('wealth', 8, '◇', 'AI 財富能量模式', '解析金錢決策、價值交換與豐盛阻塞。', 'openai', 1, 1),
       ('mission', 9, '✦', 'AI 靈魂使命', '總結靈魂任務、成熟方向與年度提醒。', 'openai', 1, 1)
